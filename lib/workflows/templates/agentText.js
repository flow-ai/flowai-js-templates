 ...
 * }))
 **/
var AgentText = /*#__PURE__*/function (_Template) {
  _inherits(AgentText, _Template);

  var _super = _createSuper(AgentText);

  /**
   * @param {string} opts.text - Required
   **/
  function AgentText(opts) {
    var _this;

    _classCallCheck(this, AgentText);
