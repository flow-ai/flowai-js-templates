...
var Carousel = /*#__PURE__*/function (_Template) {
  ...
  /**
   * @param {object|GBM.Card[]} opts - Options or shorthand for collection of {@link GBM.Card} templates
   * @param {string} opts.cardWidth - Optional. Width of the cards in the carousel
   * @param {Array} opts.cards - Optional list of {@link GBM.Card} templates
   **/
