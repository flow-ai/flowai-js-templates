...
var _locationItem = _interopRequireDefault(require("./locationItem"));

var _timeItem = _interopRequireDefault(require("./timeItem"));
...
var EventItem = /*#__PURE__*/function () {
  ...
  function EventItem(opts) {
    ...
    if (typeof location !== "undefined" && !(location instanceof _locationItem.default)) {
  ...
  _createClass(EventItem, [{
    ...
    value: function addTimeslot(item) {
      if (!(item instanceof _timeItem.default)) {
